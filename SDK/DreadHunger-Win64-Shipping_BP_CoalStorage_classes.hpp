...
#include "DreadHunger-Win64-Shipping_BP_CoalStorage_structs.hpp"

//---------------------------------------------------------------------------
//Classes
//---------------------------------------------------------------------------

// BlueprintGeneratedClass BP_CoalStorage.BP_CoalStorage_C
// size:0x0077 (0x0289 - 0x0300)
class ABP_CoalStorage_C : public ABP_StorageTrunk_C
{
public:
	...
	void ExecuteUbergraph_BP_CoalStorage(int EntryPoint)//offset:0x13CEB30;
};
