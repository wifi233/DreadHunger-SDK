...
#include "DreadHunger-Win64-Shipping_BP_Stew_View_structs.hpp"

//---------------------------------------------------------------------------
//Classes
//---------------------------------------------------------------------------

// BlueprintGeneratedClass BP_Stew_View.BP_Stew_View_C
// size:0x002C (0x02E0 - 0x030C)
class ABP_Stew_View_C : public ADH_InventoryView_Static
{
public:
	...
	void ExecuteUbergraph_BP_Stew_View(int EntryPoint)//offset:0x13CEB30;
};
