...
#include "DreadHunger-Win64-Shipping_IE_PickupLantern_parameters.hpp"
...
struct FImpactEffect UIE_PickupLantern_C::GetImpactEffects(TEnumAsByte<EPhysicalSurface>* ImpactedSurface, bool* bWasScrape)
{
	static auto fn = UObject::FindObject<UFunction>("Function IE_PickupLantern.IE_PickupLantern_C.GetImpactEffects");

	UIE_PickupLantern_C_GetImpactEffects_Params params;
