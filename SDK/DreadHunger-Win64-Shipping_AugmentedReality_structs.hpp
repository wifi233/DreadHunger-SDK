...
struct FARGeoAnchorUpdatePayload
{
	...
	struct FTransform                                  WorldTransform;                                           // 0x0020(0x0030) (BlueprintVisible, IsPlainOldData)
	float                                              Longitude;                                                // 0x0050(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	float                                              Latitude;                                                 // 0x0054(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	float                                              AltitudeMeters;                                           // 0x0058(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	EARAltitudeSource                                  AltitudeSource;                                           // 0x005C(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x005D(0x0003) MISSED OFFSET
	class FString                                      AnchorName;                                               // 0x0060(0x0010) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
};
...
struct FARMeshUpdatePayload
{
	...
	unsigned char                                      UnknownData00[0x8];                                       // 0x0018(0x0008) MISSED OFFSET
	struct FTransform                                  WorldTransform;                                           // 0x0020(0x0030) (BlueprintVisible, IsPlainOldData)
	EARObjectClassification                            ObjectClassification;                                     // 0x0050(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
...
{
	struct FTransform                                  WorldTransform;                                           // 0x0000(0x0030) (BlueprintVisible, IsPlainOldData)
};
...
{
	struct FTransform                                  WorldTransform;                                           // 0x0000(0x0030) (BlueprintVisible, IsPlainOldData)
	TArray<struct FTransform>                          JointTransforms;                                          // 0x0030(0x0010) (BlueprintVisible, ZeroConstructor)
};
...
struct FARQRCodeUpdatePayload
{
	...
	unsigned char                                      UnknownData00[0x8];                                       // 0x0018(0x0008) MISSED OFFSET
	struct FTransform                                  WorldTransform;                                           // 0x0020(0x0030) (BlueprintVisible, IsPlainOldData)
	struct FVector                                     Extents;                                                  // 0x0050(0x000C) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x005C(0x0004) MISSED OFFSET
	class FString                                      QRCode;                                                   // 0x0060(0x0010) (BlueprintVisible, ZeroConstructor)
};
...
struct FARImageUpdatePayload
{
	struct FARSessionPayload                           SessionPayload;                                           // 0x0000(0x0018) (BlueprintVisible, BlueprintReadOnly)
	unsigned char                                      UnknownData00[0x8];                                       // 0x0018(0x0008) MISSED OFFSET
	struct FTransform                                  WorldTransform;                                           // 0x0020(0x0030) (BlueprintVisible, BlueprintReadOnly, IsPlainOldData)
	class UARCandidateImage*                           DetectedImage;                                            // 0x0050(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	struct FVector2D                                   EstimatedSize;                                            // 0x0058(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
};
...
{
	struct FARSessionPayload                           SessionPayload;                                           // 0x0000(0x0018) (BlueprintVisible, BlueprintReadOnly)
	struct FVector                                     LeftEyePosition;                                          // 0x0018(0x000C) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FVector                                     RightEyePosition;                                         // 0x0024(0x000C) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FVector                                     LookAtTarget;                                             // 0x0030(0x000C) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
struct FARPlaneUpdatePayload
{
	...
	unsigned char                                      UnknownData00[0x8];                                       // 0x0018(0x0008) MISSED OFFSET
	struct FTransform                                  WorldTransform;                                           // 0x0020(0x0030) (BlueprintVisible, IsPlainOldData)
	struct FVector                                     Center;                                                   // 0x0050(0x000C) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FVector                                     Extents;                                                  // 0x005C(0x000C) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TArray<struct FVector>                             BoundaryVertices;                                         // 0x0068(0x0010) (BlueprintVisible, ZeroConstructor)
	EARObjectClassification                            ObjectClassification;                                     // 0x0078(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
...
struct FARTraceResult
{
	...
	struct FTransform                                  LocalTransform;                                           // 0x0010(0x0030) (IsPlainOldData)
...
struct FARCameraIntrinsics
{
	...
	struct FVector2D                                   FocalLength;                                              // 0x0008(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	struct FVector2D                                   PrincipalPoint;                                           // 0x0010(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
};
