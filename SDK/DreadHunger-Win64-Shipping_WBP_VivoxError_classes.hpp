...
#include "DreadHunger-Win64-Shipping_WBP_VivoxError_structs.hpp"

//---------------------------------------------------------------------------
//Classes
//---------------------------------------------------------------------------

// WidgetBlueprintGeneratedClass WBP_VivoxError.WBP_VivoxError_C
// size:0x0018 (0x0278 - 0x0290)
class UWBP_VivoxError_C : public UDH_VivoxErrorWidget
{
public:
	...
	void ExecuteUbergraph_WBP_VivoxError(int EntryPoint)//offset:0x13CEB30;
};
