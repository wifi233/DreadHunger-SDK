...
#include "DreadHunger-Win64-Shipping_IE_DamageBase_parameters.hpp"
...
struct FImpactEffect UIE_DamageBase_C::GetImpactEffects(TEnumAsByte<EPhysicalSurface> ImpactedSurface, bool bWasScrape)
{
	static auto fn = UObject::FindObject<UFunction>("Function IE_DamageBase.IE_DamageBase_C.GetImpactEffects");

	UIE_DamageBase_C_GetImpactEffects_Params params;
