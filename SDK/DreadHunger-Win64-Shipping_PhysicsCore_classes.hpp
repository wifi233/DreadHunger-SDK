...
#include "DreadHunger-Win64-Shipping_PhysicsCore_structs.hpp"
...
public:
	...
	struct FChaosSolverConfiguration                   SolverOptions;                                            // 0x0078(0x0068) (Edit, Config)
};
