...
struct FChaosSolverConfiguration
{
	...
	int                                                JointPairIterations;                                      // 0x001C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                JointPushOutPairIterations;                               // 0x0020(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              ClusterConnectionFactor;                                  // 0x0024(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	EClusterUnionMethod                                ClusterUnionConnectionType;                               // 0x0028(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bGenerateCollisionData;                                   // 0x0029(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x2];                                       // 0x002A(0x0002) MISSED OFFSET
	struct FSolverCollisionFilterSettings              CollisionFilterSettings;                                  // 0x002C(0x0010) (Edit)
	bool                                               bGenerateBreakData;                                       // 0x003C(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x003D(0x0003) MISSED OFFSET
	struct FSolverBreakingFilterSettings               BreakingFilterSettings;                                   // 0x0040(0x0010) (Edit)
	bool                                               bGenerateTrailingData;                                    // 0x0050(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x3];                                       // 0x0051(0x0003) MISSED OFFSET
	struct FSolverTrailingFilterSettings               TrailingFilterSettings;                                   // 0x0054(0x0010) (Edit)
	bool                                               bGenerateContactGraph;                                    // 0x0064(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
struct FRecordedFrame
{
	...
	unsigned char                                      UnknownData00[0x50];                                      // 0x0060(0x0050) UNKNOWN PROPERTY: 
