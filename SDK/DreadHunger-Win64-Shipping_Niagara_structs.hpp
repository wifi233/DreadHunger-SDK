...
#include "DreadHunger-Win64-Shipping_NiagaraCore_classes.hpp"
...
#include "DreadHunger-Win64-Shipping_NiagaraShader_classes.hpp"
...
struct FNiagaraVariableAttributeBinding
{
	...
	unsigned char                                      bBindingExistsOnSource;                                   // 0x0054(0x0001)
	unsigned char                                      bIsCachedParticleValue;                                   // 0x0054(0x0001)
...
struct FNiagaraVariableInfo
{
	...
	struct FText                                       Definition;                                               // 0x0020(0x0028)
...
struct FNiagaraFunctionSignature
{
	...
	unsigned char                                      bRequiresContext;                                         // 0x0030(0x0001)
	unsigned char                                      bRequiresExecPin;                                         // 0x0030(0x0001)
	unsigned char                                      bMemberFunction;                                          // 0x0030(0x0001)
	unsigned char                                      bExperimental;                                            // 0x0030(0x0001)
	unsigned char                                      bSupportsCPU;                                             // 0x0030(0x0001)
	unsigned char                                      bSupportsGPU;                                             // 0x0030(0x0001)
	unsigned char                                      bWriteFunction;                                           // 0x0030(0x0001)
	unsigned char                                      bSoftDeprecatedFunction;                                  // 0x0030(0x0001)
...
struct FNiagaraEmitterNameSettingsRef
{
	...
	class FString                                      EmitterName;                                              // 0x0008(0x0010) (Edit, ZeroConstructor)
};
...
struct FNiagaraDataSetCompiledData
{
	...
	unsigned char                                      bRequiresPersistentIDs;                                   // 0x0038(0x0001)
...
struct FNiagaraEmitterScalabilitySettings
{
	...
	unsigned char                                      bScaleSpawnCount;                                         // 0x0030(0x0001) (Edit)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0031(0x0003) MISSED OFFSET
...
struct FNiagaraPlatformSetCVarCondition
{
	...
	unsigned char                                      bUseMinInt;                                               // 0x001C(0x0001) (Edit)
	unsigned char                                      bUseMaxInt;                                               // 0x001C(0x0001) (Edit)
	unsigned char                                      bUseMinFloat;                                             // 0x001C(0x0001) (Edit)
	unsigned char                                      bUseMaxFloat;                                             // 0x001C(0x0001) (Edit)
...
{
	unsigned char                                      bOverrideSpawnCountScale;                                 // 0x0038(0x0001) (Edit)
...
{
	struct FNiagaraPlatformSet                         Platforms;                                                // 0x0000(0x0030) (Edit)
	unsigned char                                      bCullByDistance;                                          // 0x0030(0x0001) (Edit)
	unsigned char                                      bCullMaxInstanceCount;                                    // 0x0030(0x0001) (Edit)
	unsigned char                                      bCullPerSystemMaxInstanceCount;                           // 0x0030(0x0001) (Edit)
	unsigned char                                      bCullByMaxTimeWithoutRender;                              // 0x0030(0x0001) (Edit)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0031(0x0003) MISSED OFFSET
...
{
	unsigned char                                      bOverrideDistanceSettings;                                // 0x0048(0x0001) (Edit)
	unsigned char                                      bOverrideInstanceCountSettings;                           // 0x0048(0x0001) (Edit)
	unsigned char                                      bOverridePerSystemInstanceCountSettings;                  // 0x0048(0x0001) (Edit)
	unsigned char                                      bOverrideTimeSinceRendererSettings;                       // 0x0048(0x0001) (Edit)
...
struct FNiagaraVMExecutableData
{
	...
	unsigned char                                      bReadsSignificanceIndex;                                  // 0x00D8(0x0001)
...
struct FNiagaraVMExecutableDataId
{
	...
	unsigned char                                      bUsesRapidIterationParams;                                // 0x0024(0x0001)
	unsigned char                                      bInterpolatedSpawn;                                       // 0x0024(0x0001)
	unsigned char                                      bRequiresPersistentIDs;                                   // 0x0024(0x0001)
...
struct FNiagaraModuleDependency
{
	...
	unsigned char                                      UnknownData00[0x6];                                       // 0x000A(0x0006) MISSED OFFSET
	struct FText                                       Description;                                              // 0x0010(0x0028) (Edit)
};
...
struct FNiagaraScriptExecutionParameterStore : public FNiagaraParameterStore
{
	...
	unsigned char                                      bInitialized;                                             // 0x0090(0x0001)
...
{
	struct FText                                       Description;                                              // 0x0000(0x0028) (Edit)
	struct FText                                       CategoryName;                                             // 0x0018(0x0028) (Edit)
	...
	TMap<struct FName, class FString>                  PropertyMetaData;                                         // 0x0070(0x0050) (Edit)
	struct FName                                       ParentAttribute;                                          // 0x00C0(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	struct FName                                       ScopeName;                                                // 0x00C8(0x0008) (ZeroConstructor, IsPlainOldData)
	ENiagaraScriptParameterUsage                       Usage;                                                    // 0x00D0(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x3];                                       // 0x00D0(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	bool                                               bIsStaticSwitch;                                          // 0x00D4(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x3];                                       // 0x00D5(0x0003) MISSED OFFSET
	int                                                StaticSwitchDefaultValue;                                 // 0x00D8(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               bAddedToNodeGraphDeepCopy;                                // 0x00DC(0x0001) (ZeroConstructor, Transient, IsPlainOldData)
	bool                                               bOutputIsPersistent;                                      // 0x00DD(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x2];                                       // 0x00DE(0x0002) MISSED OFFSET
	struct FName                                       CachedNamespacelessVariableName;                          // 0x00E0(0x0008) (ZeroConstructor, IsPlainOldData)
	bool                                               bCreatedInSystemEditor;                                   // 0x00E8(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bUseLegacyNameString;                                     // 0x00E9(0x0001) (ZeroConstructor, IsPlainOldData)
...
struct FNiagaraInputConditionMetadata
{
	...
	TArray<class FString>                              TargetValues;                                             // 0x0008(0x0010) (Edit, ZeroConstructor)
};
...
struct FNiagaraParameterScopeInfo
{
	...
	class FString                                      NamespaceString;                                          // 0x0008(0x0010) (ZeroConstructor)
};
...
{
	class FString                                      Object;                                                   // 0x0000(0x0010) (ZeroConstructor)
	TArray<class FString>                              PropertyKeys;                                             // 0x0010(0x0010) (ZeroConstructor)
	TArray<class FString>                              PropertyValues;                                           // 0x0020(0x0010) (ZeroConstructor)
};
