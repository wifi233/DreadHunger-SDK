...
#include "DreadHunger-Win64-Shipping_WBP_LobbyLeaderSlotSpacer_structs.hpp"

//---------------------------------------------------------------------------
//Classes
//---------------------------------------------------------------------------

// WidgetBlueprintGeneratedClass WBP_LobbyLeaderSlotSpacer.WBP_LobbyLeaderSlotSpacer_C
// size:0x0008 (0x0260 - 0x0268)
class UWBP_LobbyLeaderSlotSpacer_C : public UUserWidget
{
public:
