...
#include "DreadHunger-Win64-Shipping_IE_PickupTea_parameters.hpp"
...
struct FImpactEffect UIE_PickupTea_C::GetImpactEffects(TEnumAsByte<EPhysicalSurface>* ImpactedSurface, bool* bWasScrape)
{
	static auto fn = UObject::FindObject<UFunction>("Function IE_PickupTea.IE_PickupTea_C.GetImpactEffects");

	UIE_PickupTea_C_GetImpactEffects_Params params;
