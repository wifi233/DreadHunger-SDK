...
struct FGeometryCollectionSource
{
	...
	struct FTransform                                  LocalTransform;                                           // 0x0020(0x0030) (Edit, BlueprintVisible, IsPlainOldData)
	TArray<class UMaterialInterface*>                  SourceMaterial;                                           // 0x0050(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
};
