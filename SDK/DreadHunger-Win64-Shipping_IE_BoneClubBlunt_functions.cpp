...
#include "DreadHunger-Win64-Shipping_IE_BoneClubBlunt_parameters.hpp"
...
struct FImpactEffect UIE_BoneClubBlunt_C::GetImpactEffects(TEnumAsByte<EPhysicalSurface>* ImpactedSurface, bool* bWasScrape)
{
	static auto fn = UObject::FindObject<UFunction>("Function IE_BoneClubBlunt.IE_BoneClubBlunt_C.GetImpactEffects");

	UIE_BoneClubBlunt_C_GetImpactEffects_Params params;
