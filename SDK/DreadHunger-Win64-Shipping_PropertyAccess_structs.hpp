...
{
	TFieldPath<ArrayProperty>                          ArrayProperty;                                            // 0x0000(0x0020)
...
{
	TFieldPath<Property>                               Property;                                                 // 0x0000(0x0020)
...
struct FPropertyAccessPath
{
	...
	unsigned char                                      bHasEvents;                                               // 0x0008(0x0001)
...
struct FPropertyAccessSegment
{
	...
	TFieldPath<Property>                               Property;                                                 // 0x0010(0x0020)
