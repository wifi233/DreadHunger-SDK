...
#include "DreadHunger-Win64-Shipping_WBP_CraftingRecipe_structs.hpp"

//---------------------------------------------------------------------------
//Classes
//---------------------------------------------------------------------------

// WidgetBlueprintGeneratedClass WBP_CraftingRecipe.WBP_CraftingRecipe_C
// size:0x0018 (0x0328 - 0x0340)
class UWBP_CraftingRecipe_C : public UDH_CraftingRecipeWidget
{
public:
	...
	void ExecuteUbergraph_WBP_CraftingRecipe(int EntryPoint)//offset:0x13CEB30;
};
