...
#include "DreadHunger-Win64-Shipping_BP_GunCabinet_classes.hpp"
...
struct ABP_GunCabinet_C_OnStorageClosed_Params
{
...
struct ABP_GunCabinet_C_ReceiveBeginPlay_Params
{
};

// Function BP_GunCabinet.BP_GunCabinet_C.OnStorageOpened
struct ABP_GunCabinet_C_OnStorageOpened_Params
{
	class UDH_InventoryManager*                        OtherInventory;                                           // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData)
};

// Function BP_GunCabinet.BP_GunCabinet_C.ExecuteUbergraph_BP_GunCabinet
struct ABP_GunCabinet_C_ExecuteUbergraph_BP_GunCabinet_Params
{
