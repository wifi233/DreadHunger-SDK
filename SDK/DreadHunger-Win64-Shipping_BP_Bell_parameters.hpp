...
#include "DreadHunger-Win64-Shipping_BP_Bell_classes.hpp"
...
struct ABP_Bell_C_SwingSound_Params
{
};

// Function BP_Bell.BP_Bell_C.RingBell
struct ABP_Bell_C_RingBell_Params
{
};

// Function BP_Bell.BP_Bell_C.OnRep_HitFlash
struct ABP_Bell_C_OnRep_HitFlash_Params
{
};

// Function BP_Bell.BP_Bell_C.ReceiveAnyDamage
struct ABP_Bell_C_ReceiveAnyDamage_Params
{
...
struct ABP_Bell_C_ReceivePointDamage_Params
{
	float                                              Damage;                                                   // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
	class UDamageType*                                 DamageType;                                               // (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
